...
namespace Cpuche\Blog\Api\Providers;
...
class BlogApiServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../config/blog-api.php' => config_path('blog-api.php'),
        // ], 'config');
        ...
        // $this->loadRoutesFrom(__DIR__.'/../../routes/web.php');
         $this->loadRoutesFrom(__DIR__.'/../../routes/api/v1/api.php');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'blog-api');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'blog-api');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/blog-api'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'blog-api');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/blog-api'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \Cpuche\Blog\Api\Console\Commands\BlogApiCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/blog-api'),
        // ], 'public');
...
//         ], 'migrations');
	     ...
	     */
	     //$this->publishes([
	     //    __DIR__.'/../../database/seeders/' => database_path('seeders/blog')
	     //], 'seeders');
    }
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/blog-api.php', 'blog-api'
        // );
    }
}
